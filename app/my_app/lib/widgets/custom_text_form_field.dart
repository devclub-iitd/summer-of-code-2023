...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get outlineGray500 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            8.00,
          ),
  ...
  static OutlineInputBorder get outlineBlack900LR35 => OutlineInputBorder(
  ...
  static OutlineInputBorder get outlineBlack900TL8 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            8.00,
          ),
