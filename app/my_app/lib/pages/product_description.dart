...
class _ProductDescriptionState extends State<ProductDescription> {
  ...
  getCart() {
    cartApiService
        .getMyCart(FirebaseAuth.instance.currentUser!.email!, context)
        .then((value) {
      Provider.of<ProductProvider>(context, listen: false)
          .setCartLength(value[2]);
    });
  }
  ...
  checkifinwish() {
    if (widget.product.id.isNotEmpty) {
      apiService
          .isInWishlist(
              widget.product.id, FirebaseAuth.instance.currentUser!.email!)
          .then((value) {
        setState(() {
          isInWishlist = value;
        });
              ...
              children: [
                          ...
                          Row(
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  nextScreen(context,
                                      AddressDetails(onCheckOut: false));
                                },
                                child: Container(
                            ...
                            children: [
                              ...
                              CustomTextFormField(
                                  ...
                                  fillColor: theme.colorScheme.onPrimary
                                      .withOpacity(1),
                                  defaultBorderDecoration:
                                      TextFormFieldStyleHelper.outlineGray500,
                                  enabledBorderDecoration:
                                      TextFormFieldStyleHelper.outlineGray500,
                                  focusedBorderDecoration:
                                      TextFormFieldStyleHelper.outlineGray500,
                              ...
                              CustomIconButton(
                                  ...
                                  width: 36,
                                  margin:
                                      getMargin(left: 16, top: 2, bottom: 2),
                                  padding: getPadding(all: 6),
                                  child: CustomImageView(
                                      svgPath: ImageConstant.imgIcon))
                            ]))),
                Padding(
                    padding: getPadding(left: 16, top: 24, right: 15),
                    child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                ...
                SizedBox(
                    ...
                    child: ListView.separated(
                        padding: getPadding(left: 17, top: 15, right: 48),
